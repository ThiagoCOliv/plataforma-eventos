...
export class UserService 
{
  ...
  loginUser(userInfo: any): Observable<HttpResponse<any>>
  {
    return this.http.post(`${this.apiUrl}/login`, { email: userInfo.email, password: userInfo.password }, { observe: 'response' });
  }
